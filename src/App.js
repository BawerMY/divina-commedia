...
function App() {
  ...
  return (
    <>
      ...
      {page[0]<1 && page[1]==0 && <svg className="fixed translate-x-[50%] -translate-y-[50%] top-[50vh] right-[12.5vw] opacity-20 w-64" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor">
        <path strokeLinecap="round" strokeLinejoin="round" d="M8.25 4.5l7.5 7.5-7.5 7.5" />
      </svg>}
      {page[1]>-1 && page[0]==0 && <svg className="fixed translate-x-[50%] translate-y-[50%] bottom-[15vh] right-[50vw] opacity-20 w-64" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor">
        <path strokeLinecap="round" strokeLinejoin="round" d="M19.5 8.25l-7.5 7.5-7.5-7.5" />
      </svg>}
      {page[1]<1 && page[0]==0 && <svg className="fixed translate-x-[50%] -translate-y-[50%] top-[15vh] right-[50vw] opacity-20 w-64" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor">
