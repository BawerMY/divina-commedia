    ...
    return (
        <div className="flex flex-col w-full">
            ...
            <div className="flex flex-col items-center bg-gradient-to-b to-cyan-100 from-95% from-amber-900">
                <div className="bg-red-700 w-[4%] text-center py-32">LUCIFERO</div>
                <div className="border-b-4 border-amber-950 bg-gradient-to-t from-amber-600 to-transparent to-100% rounded-b-[100%] w-[8%] text-center py-32">GIUDECCA</div>
                <div className="border-b-4 border-amber-950 bg-gradient-to-t from-amber-600 to-transparent to-100% rounded-b-[100%] w-[12%] text-center py-32">TOLOMEA</div>
                ...
                <div className="border-b-4 border-amber-950 bg-gradient-to-t from-amber-600 to-transparent to-100% rounded-b-[100%] w-[44%] text-center py-32">LADRI</div>
                <div className="border-b-4 border-amber-950 bg-gradient-to-t from-amber-600 to-transparent to-100% rounded-b-[100%] w-[48%] text-center py-32">IPOCRITI</div>
                <div className="border-b-4 border-amber-950 bg-gradient-to-t from-amber-600 to-transparent to-100% rounded-b-[100%] w-[52%] text-center py-32">BARATTERI</div>
                <div className="border-b-4 border-amber-950 bg-gradient-to-t from-amber-600 to-transparent to-100% rounded-b-[100%] w-[56%] text-center py-32">INDOVINI</div>
                <div className="border-b-4 border-amber-950 bg-gradient-to-t from-amber-600 to-transparent to-100% rounded-b-[100%] w-[60%] text-center py-32">SIMONIACI</div>
                ...
                <div className="border-b-4 border-amber-950 bg-gradient-to-t from-amber-600 to-transparent to-100% rounded-b-[100%] w-[92%] text-center py-32">VIOLENTI</div>
                <div className="border-b-4 border-amber-950 bg-gradient-to-t from-amber-600 to-transparent to-100% rounded-b-[100%] w-[96%] text-center py-32">ERETICI</div>
                <div className="border-b-4 border-amber-950 bg-gradient-to-t from-amber-600 to-transparent to-100% rounded-b-[100%] w-[100%] text-center py-32">MURA DELLA CITTA' di DITE / STIGE</div>
            </div>
        </div>
    )
}